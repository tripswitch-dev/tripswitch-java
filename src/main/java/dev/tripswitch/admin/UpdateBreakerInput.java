...
public record UpdateBreakerInput(
    ...
    public static class Builder {
        ...
        private BreakerKind kind;
        private Map<String, Object> kindParams;
        private BreakerOp op;
        ...
        public Builder kind(BreakerKind v) { this.kind = v; return this; }
        public Builder kindParams(Map<String, Object> v) { this.kindParams = v; return this; }
        public Builder op(BreakerOp v) { this.op = v; return this; }
        ...
        public UpdateBreakerInput build() {
            return new UpdateBreakerInput(name, metric, kind, kindParams, op, threshold,
